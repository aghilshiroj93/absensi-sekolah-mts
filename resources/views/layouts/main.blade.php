...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav
            class="main-header navbar navbar-expand navbar-white navbar-light shadow-sm animate__animated animate__fadeInDown">
            <!-- Left navbar links -->
            <!-- Top Menu -->
